<section class="flex justify-center bg-purple-300">
	<p class="p-10 w-3/4 text-justify text-sm sm:text-lg">
		...
		scelerisque, vehicula purus eu, vulputate quam. Nunc aliquam, enim vel tristique interdum, neque
		purus pharetra dui, eu fringilla lectus magna quis turpis. Aliquam vitae nunc in risus tincidunt
		tincidunt. Aenean sed sem congue, suscipit risus non, ullamcorper arcu.
	</p>
</section>
